...
class Env:
    def __init__(self, df, full_battery_capacity=20, n_days=2, n_steps=1000, low=0, high=30000, test=False):
    ...
    def take_action(self, action):
        ...
        if action == 0:
            ...
            battery_charged_from_grid = min(self.full_battery_capacity - capacity, MAX_BATTERY_ENERGY)
            ...
            house_powered_from_battery = min(capacity, MAX_BATTERY_ENERGY, consumption)
            ...
            battery_energy_to_sell = min(new_capacity, MAX_BATTERY_ENERGY - house_powered_from_battery)
            ...
            house_powered_from_battery = min(capacity, MAX_BATTERY_ENERGY, consumption + ev_consumption)
